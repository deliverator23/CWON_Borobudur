...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="D:\Civ6Mod\3D\Wonders\Borobudur\borobudur_ground_hm3.dds"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>2229356973</m_ExportedTime>
	<m_ClassName text="Decal_Heightmap"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="borobudur_ground_hm3.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="borobudur_ground_hm3"/>
	<m_Description text=""/>
	<m_Tags/>
</AssetObjects..TextureInstance>
